...
interface TeacherEditPresenterProps {
    ...
    loading?: boolean
    control: Control<UpdateTeacherCommand, UpdateTeacherCommand>
...
export const TeacherEditPresenter = ({
    ...
    control,
    formData
}: TeacherEditPresenterProps) => {

    return (
        <LayoutForm
            title={'Editar Profesor '+(formData.firstName || "")}
                ...
                <div className="lg:col-span-2">
                    <Card>
                        <CardHeader className="pb-3">
                            ...
                            <CardDescription>
                                Completa los campos para editar la información del profesor. Asegúrate de que toda la información sea correcta antes de guardar.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
